...
# Hyperparameter tuning --------------------------------------------------------
 ...
 # specify model
  ...
  # xgb_grid <- dails::grid_random(dials::tree_depth(),
  #                                dials::min_n(),
  ...
  xgb_grid <- dails::grid_latin_hypercube(
    dails::tree_depth(),
    dails::min_n(),
    dails::loss_reduction(),
    sample_size = dails::sample_prop(),
    dails::finalize(dails::mtry(), df_training),
    dails::learn_rate(),
    size = 500
  )
  ...
  metrics <- collect_metrics(xgb_tuning)
